...
import { ShoppingCart, Menu, User, Moon, Sun, MapPin, ChevronDown, CircleUser } from "lucide-react";
...
export default function Header() {
  ...
  return (
    ...
    <div className="flex items-center justify-between m-4">
      <div>
        <p className="text-gray-500 text-xs">Deliver Now</p>
        <button className="text-lg font-bold flex items-center gap-1">
          HR Layout
